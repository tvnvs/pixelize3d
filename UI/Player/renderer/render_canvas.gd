...
func _on_viewport_options_player_position_changed(_transform: Vector3) -> void:
	player_node.position = _transform


func _on_viewport_options_player_rotation_changed(_transform: Vector3) -> void:
	player_node.rotation_degrees = _transform
